...
namespace RoutingExample.RoutingSystem
{
    public class GraphFactory
    {
        ...
        public GraphFactory(VectorLayer theLayer)
        {
            ...
            var datasour = theLayer.DataSource as IProvider;

            var featureIds = datasour.GetObjectIDsInView(theLayer.Envelope);
            ...
            {
                var feature = datasour.GetGeometryByID(featureID);
        ...
        public IntersectionPackage TranslateToPointOnLine(Coordinate userPoint, double tolerence, double growValue, VectorLayer theLayer)
        {
            try
            {
                ...
                if (geometrysInTolerence.Count > 0)
                {
                    ...
                    IGeometry closestToThisLine = null;
                    ...
                    foreach (IGeometry geometryInTolerence in geometrysInTolerence)
                    {
                        ...
                        if (lDistance < closestDistance)
                        {
                            ...
                            closestToThisLine = geometryInTolerence;
                        }
                    }
        ...
        public ILineString[] SplitTheLine(IGeometry toBeSplit, IPoint splitPoint)
        {
            ...
            var res = new[]
                {
                    (IGeometry)ExtractLineByLocation.Extract(toBeSplit, llStart, llSplit),
                    (IGeometry)ExtractLineByLocation.Extract(toBeSplit, llSplit, llEnd)
                };
